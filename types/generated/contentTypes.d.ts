...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    floatSmallLabel: Schema.Attribute.String;
    floatSmallValue: Schema.Attribute.String;
    floatStatLabel: Schema.Attribute.String;
    floatStatSub: Schema.Attribute.String;
    floatStatValue: Schema.Attribute.String;
    image: Schema.Attribute.String;
    imageAlt: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about.about'> &
      Schema.Attribute.Private;
    missionScriptureReference: Schema.Attribute.String;
    missionScriptureText: Schema.Attribute.Text;
    missionText: Schema.Attribute.Text;
    pillars: Schema.Attribute.JSON;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiBookingBooking extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    scriptureReference: Schema.Attribute.String;
    scriptureText: Schema.Attribute.Text;
...
export interface ApiContentFeatureContentFeature
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    featureId: Schema.Attribute.String & Schema.Attribute.Unique;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::content-feature.content-feature'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    badgeColor: Schema.Attribute.Enumeration<['cyan', 'white']> &
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    scriptureOfWeekReference: Schema.Attribute.String;
    scriptureOfWeekText: Schema.Attribute.Text;
    tagline: Schema.Attribute.String;
    taglineVerse: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    mainImageSrc: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    scriptureReference: Schema.Attribute.String;
    scriptureText: Schema.Attribute.Text;
    smallImages: Schema.Attribute.JSON;
    stats: Schema.Attribute.JSON;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::content-feature.content-feature': ApiContentFeatureContentFeature;
